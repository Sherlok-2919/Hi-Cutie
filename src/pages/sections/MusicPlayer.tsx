...
export default function MusicPlayer() {
  ...
  return (
    <section className="py-12 sm:py-16 px-4 bg-gradient-to-br from-purple-100 via-pink-50 to-blue-50">
      <div className="max-w-3xl mx-auto">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative bg-white/80 backdrop-blur-lg rounded-3xl p-6 sm:p-8 shadow-2xl border border-white/40"
        >
          {/* Vinyl Record */}
          ...
          <div className="flex flex-col items-center gap-4 w-full">
            ...
            <p className="text-gray-600 text-sm italic text-center px-4">
              {isPlaying ? 'Playing our special song...' : 'Click to play our song'}
            </p>

            <div className="w-full mt-2">
              <label htmlFor="volume" className="block text-xs uppercase tracking-widest text-gray-500 mb-2 text-center">
                Volume
              </label>
              <div className="flex items-center gap-3">
                <span className="text-sm text-gray-500 font-semibold w-8 text-right">
                ...
                />
                <span className="text-sm text-gray-400 w-10">Max</span>
              </div>
            </div>
