              ...
              <AnimatePresence mode="wait">
                {!crackedCookies.has(fortune.id) ? (
                  <motion.div
                    ...
                    className="cursor-pointer text-center p-6 bg-gradient-to-br from-amber-100 to-orange-100 rounded-3xl shadow-lg hover:shadow-xl transition-shadow"
                  >
                    <div className="text-7xl mb-2">🥠</div>
                    <p className="text-sm font-medium text-gray-600">Tap to open</p>
                  </motion.div>
                ) : (
                  <motion.div
                    key="fortune"
                    ...
                    transition={{ duration: 0.5 }}
                    className="p-6 bg-gradient-to-br from-pink-100 to-purple-100 rounded-3xl shadow-xl min-h-[200px] flex items-center justify-center"
                  >
